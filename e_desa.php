...
$det=mysql_query("select * from desa where id_desa='$id'")or die(mysql_error());
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" action="p_e_desa.php" >
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="kades" id="kades"  value="<?php echo $d['kades'] ?>"/>
                                            </div>                                            
                                            <span class="help-block">Isi Nama Kades Disini</span>
                                        </div>
                                    </div>
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="jumlah_kk" id="jumlah_kk"  value="<?php echo $d['jumlah_kk'] ?>"/>
                                            </div>                                            
