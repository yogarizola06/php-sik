                ...
                <!-- END X-NAVIGATION VERTICAL -->       
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" action="p_t_kecamatan.php" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Input</strong> Kecamatan</h3>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name="jumlah_desa"/>
                                            </div>                                            
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="id_kab">
                                                <option>Pilih Kabupaten</option>
                                                    ...
                                                    ?>
                                                <option value="<?php echo $cat_row['id_kabupaten']; ?>"><?php echo $cat_row['nama_kabupaten']; ?>
